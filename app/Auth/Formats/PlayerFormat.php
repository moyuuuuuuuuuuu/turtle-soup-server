...
final class PlayerFormat
{
     ...
     * @return array{provider: string, provider_label: string, bound_at: \Illuminate\Support\Carbon|null}
     */
     ...
     * @return list<array{provider: string, provider_label: string, bound_at: \Illuminate\Support\Carbon|null}>
     */
