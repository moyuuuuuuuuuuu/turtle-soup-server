...
return [
    ...
    'prefix' => 'hgt:api-rate:',
    'rules' => [
        ['methods' => ['POST'], 'paths' => ['/api/v1/anonymous/session', '/api/v1/anonymous/session/renew'], 'limit' => 5, 'window' => 60],
        ['methods' => ['POST'], 'paths' => ['/api/v1/anonymous/session', '/api/v1/anonymous/session/renew'], 'limit' => 50, 'window' => 86400],
        ['methods' => ['POST'], 'paths' => ['/api/v1/games'], 'limit' => 20, 'window' => 60],
        ['methods' => ['POST'], 'paths' => ['/api/v1/games'], 'limit' => 500, 'window' => 86400],
