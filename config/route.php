...
Route::get('/api/v1/auth/wechat-official/authorize-url', [App\Auth\Controllers\PlayerAuthController::class, 'wechatOfficialAuthorizeUrl']);
Route::post('/api/v1/auth/login/wechat-official', [App\Auth\Controllers\PlayerAuthController::class, 'wechatOfficialLogin']);
Route::post('/api/v1/auth/login/open-platform', [App\Auth\Controllers\PlayerAuthController::class, 'openPlatformLogin']);
...
Route::get('/api/v1/me/identities', [App\Auth\Controllers\PlayerAuthController::class, 'identities']);
Route::post('/api/v1/me/identities/mini-program', [App\Auth\Controllers\PlayerAuthController::class, 'bindMiniProgramIdentity']);
Route::post('/api/v1/me/identities/wechat-official', [App\Auth\Controllers\PlayerAuthController::class, 'bindWechatOfficialIdentity']);
Route::post('/api/v1/me/identities/open-platform', [App\Auth\Controllers\PlayerAuthController::class, 'bindOpenPlatformIdentity']);
Route::delete('/api/v1/me/identities', [App\Auth\Controllers\PlayerAuthController::class, 'unbindIdentity']);
